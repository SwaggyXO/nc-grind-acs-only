...
public:
    vector<vector<string>> groupAnagrams(vector<string>& strs) {
        ...
        // wrong. on so many accounts. simple addition is not it.
        // need to think more about edge cases. really lacking there.
        // going back to the thing I had in find right away - sorting.
        // ok. somehow the sorting solution is the fastest?
        // I will dig more.
